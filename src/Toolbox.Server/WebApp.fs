...
let service = {
    ...
    SolveSudoku = fun currentBoard ->
        task {
            let solvedSudoku = Toolbox.Shared.API.SudokuSolver.solveSudoku currentBoard (Toolbox.Shared.API.SudokuSolver.getPossibilities currentBoard)
